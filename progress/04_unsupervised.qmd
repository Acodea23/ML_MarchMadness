...
```
![Alt text](images/screeplotearlier2.png)
...
```
![Alt text](images/pcavpc2redblue.png)
...
```
![Alt text](images/3dpcascatterearlierone.png)
...
<Figure size 1100x700 with 1 Axes>
```
![Alt text](images/pcaonlypc1vpc2.png)
...
<Figure size 1200x900 with 1 Axes>
```
![Alt text](images/3dpcascatter.png)
